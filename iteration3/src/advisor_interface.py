class advisor_interface:
    ...
    def show_weekly_schedule(self, courses):
        ...
        monday_courses_place, tuesday_courses_place, wednesday_courses_place, thursday_courses_place, friday_courses_place, saturday_courses_place, sunday_courses_place = ([] for _ in range(7))

        print("\n>> Weekly Schedule")
        print("------------------------------------------------------------------------------------------------------------------------------------------")
        print("|  {:<15}|  {:<14}|  {:<14}|  {:<14}|  {:<14}|  {:<14}|  {:<14}|  {:<14}|".format("", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"))
